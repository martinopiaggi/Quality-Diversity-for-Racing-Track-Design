...
parser.add_argument("--json-output", action="store_true", help = "Output raw metrics in JSON format")
...
for path in args.paths:
    ...
    blocks.makeMetricsPlots(os.getcwd() + "/" + folderName, 
